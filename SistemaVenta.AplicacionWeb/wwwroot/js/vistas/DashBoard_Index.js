        ...
        .then(responseJson => {
            ...
            if (responseJson.estado) {
                ...
                if (d.ventasUltimaSemana.length > 0) {
                    barchart_labels = d.ventasUltimaSemana.map(item => item.fecha);
                    barchart_data = d.ventasUltimaSemana.map(item => item.total);
                } else {
                ...
                if (d.productosTopUltimaSemana.length > 0) {
                    piechart_labels = d.productosTopUltimaSemana.map(item => item.producto);
                    piechart_data = d.productosTopUltimaSemana.map(item => item.cantidad);
                } else {
