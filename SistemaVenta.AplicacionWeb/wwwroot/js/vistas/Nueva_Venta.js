...
$(document).ready(function () {
    ...
    //Configuracion de la libreria Select2
...
function formatoResultados(data) {
    //El if es por defecto, ya que muestra el "buscando..."
    if (data.loading)
        return data.text;
...
//Lógica para que el focus se posicione directamente en el input de "Buscar Producto..."
